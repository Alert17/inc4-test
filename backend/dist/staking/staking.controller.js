...
let StakingController = class StakingController {
    ...
    distributeRewards(body // Типизация для объекта в body
    ) {
        return __awaiter(this, void 0, void 0, function* () {
            const { stakers, totalReward } = body;
            yield this.stakingService.distributeRewards(stakers, totalReward);
...
__decorate([
    (0, common_1.Post)('distribute-rewards'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], StakingController.prototype, "distributeRewards", null);
__decorate([
    (0, common_1.Get)('statistics'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], StakingController.prototype, "getStatistics", null);
